...
if api_key is None:
    st.error("API key is missing. Make sure to set it in the .env file.")
else:
...
def get_conversational_chain():
    prompt_template = """
    Understand the given question. Retrieve its answer from the provided context. Provide the final answer in the most descriptive manner.\n\n
    Answer the following question in detailed step by step.\n\n
    Context:\n {context}?\n
    Question: \n{question}\n
